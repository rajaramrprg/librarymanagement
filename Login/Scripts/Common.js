var Common = {
    GetData: function(webApiRequest, actionMethodType, postData, successCallback, failureCallback, isAsync){
		...
		date_now = Math.floor(Date.now() / 1000);
		$.ajax({
        url : webApiRequest,
        method: 'GET',
		headers : {'auth_token' : date_now},
		dataType: 'json',
