var allbooklist = function () {
    ...
    function LoaddPage(){
        Common.LoadHTMLPage("Html/user/allbooklist.php",
        function (htmlView) {
    ...
    function loadcommonFunctions(){
        ...
        $(document).one('click','.view_descp', function(){
            var book_id = $(this).attr('data-id');
            bookdesc(book_id).Init();
        });

		Services.getallbookswithoutSubcription(null,function (bindata) {
